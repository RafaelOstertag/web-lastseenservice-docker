...
RUN curl -fk -o /tmp/app.jar https://colossus.kruemel.home/nexus/repository/webtools-maven/ch/guengel/webtools/lastseenservice/$VERSION/lastseenservice-${VERSION}-jar-with-dependencies.jar
